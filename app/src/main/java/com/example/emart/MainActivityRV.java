...
public class MainActivityRV extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataRVAdapter = new DataRVAdapter(g, this);
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        if (!queryDocumentSnapshots.isEmpty()) {
                            ...
                            Toast.makeText(MainActivityRV.this, "No data found in Database", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(MainActivityRV.this, "Fail to get the data.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}
