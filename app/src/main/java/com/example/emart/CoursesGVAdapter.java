...
public class CoursesGVAdapter extends ArrayAdapter<DataModal_RV> {

    // constructor for our list view adapter.
    public CoursesGVAdapter(@NonNull Context context, ArrayList<DataModal_RV> dataModalArrayList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        // our modal class.
        DataModal_RV dataModal = getItem(position);
